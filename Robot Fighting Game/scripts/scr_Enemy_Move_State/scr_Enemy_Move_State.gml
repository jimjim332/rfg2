...
*/
dirx = obj_Player.x - obj_SwEnemy1.x //x greater than 0 equals right // x smaller than 0 equals left
diry = obj_Player.y - obj_SwEnemy1.y //y greater than 0 equals down // y smaller than 0 equals up
if(diry > 0)
{
	sprite_index = spr_SwEnemy1_D;	
} else if(diry < 0)
