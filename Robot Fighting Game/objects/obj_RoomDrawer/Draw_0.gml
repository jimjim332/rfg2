...
for (i = 0; i < 10; i += 1)
   {
	   draw_text(x,obj_LevelPicker.yspace*i,string(my_array4[i]))
   }
}
//
//draw_text(x,y,"Press enter to go to Level 21")
...
if(room = rm_Lvl_Search_More_3)
{
	{
		draw_set_color(hcl5)
		draw_text(x,obj_LevelPicker.Row*obj_LevelPicker.yspace,string(my_array4[obj_LevelPicker.Row]))
	}
}